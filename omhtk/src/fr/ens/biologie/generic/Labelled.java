...
/**
 * For any object that has a label  
...
public interface Labelled {
	...
	/**
	 * checks if this instance has the same label as the argument
	 * @param item another Labelled instance
	 * @return true if both have the same label
	 */
	public boolean sameLabel(Labelled item);
	
	/**
	 * checks the label has a given value
	 * @param label
	 * @return
	 */
