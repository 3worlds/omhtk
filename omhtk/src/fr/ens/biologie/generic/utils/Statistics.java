...
/**
 * Functions to compute statistics iteratively. They all return stat(n+1) as a function
 * of xn, n, and stats(n). Optimised for speed.
 * TODO: contingency tables for Strings
 * <p>This class performs statistics using numbers that regularly come in. The use pattern is as follows:
 * <pre>
