...
/**
 * <p>A simple method code generator for java classes. It does not handle exceptions, 
 * nor annotations, and provides only limited support for 
 * <a href="https://docs.oracle.com/javase/tutorial/java/generics/types.html">generic types</a>.</p>
 * <p>Usage:</p>
 * <ol>
 * <li>Get an instance of {@link ClassGenerator}. If it has a superclass or implements interfaces,
 * it will generate instances of {@code MethodGenerator} for every abstract method found
 * in the superclass / interfaces.</li>
 * <li>Get the method generator you want to work with {@code ClassGenerator.getMethod(...)} or
 * {@code ClassGenerator.getMethods()}.</li>
 * <li>Update the method generator as you want, populating it with statements etc.</li>
 * <li>When you call {@code asText(...)} on your {@code ClassGenerator}, it will call this class 
 * {@link MethodGenerator#asText(String) asText(...)} method so that all the edits you
 * made in your method generator will be reflected in the generated code. Basically, you should
 * never need to call {@code MethodGenerator.asText(...)} directly - unless you want to generate
...
public class MethodGenerator implements JavaCode {
	 ...
	 * constructors from superclass / interfaces and used by the {@link ClassGenerator}
	 * to generate appropriate {@code import} statements.
	 * 
	...
	/**
	 * Insert code insertion comments in the method body. These are comments telling the end-user
	 * where they can include new code.
	 */
	...
	/**
	 * Constructor from a superclass method. Copies all method information from the ancestor.
	 * <p>CAUTION: generic type arguments (ie containing &lt;?&gt; or &lt;T&gt;) are not supported.</p>
	 * 
...
//		}
	 ...
	 * return statements higher in the method body, use {@link MethodGenerator#setStatement(String) setStatement(...)}
	 * instead.
	...
	/**
	 * Set an argument type. Use with caution in the case of inherited methods as conflicts may arise.
	 * Generic types (ie containing &lt;?&gt; or &lt;T&gt;) can be set here.
	 * 
	...
	/**
	 * Set all argument names. Names must come in the proper order to match the argument types.
	 * 
	...
	/**
	 * Set the return type of this method. Use with caution it the method is inherited.
	 * 
