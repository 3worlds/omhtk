...
/**
 * A class to record the running environment of a java application, e.g. operating system, user name,
 * number of CPUs, current directory, etc. Most of the file operations are now redundant with the
 * {@link org.apache.commons.io.FileUtils} package. It may be used to represent a local environment
 * or a remote environment, for applications running processes on multiple computers.
 * 
...
public abstract class Environment {
	 ...
	 * @param workingDirectory the working directory from where the command is executed
	...
	/**
	 * Execute an operating system command and throws an Exception if an error occurred 
	 * during execution.
	 * 
	 * @param command the command to execute
	 * @param workingDirectory the working directory from where the command is executed
	...
	/**
	 * Execute an operating system command  in the current directoryand throws an Exception 
	...
	/**
	 * Create a tree of nested directories as specified by its argument in the OS file system.
	...
	/**
	 * Get the current running version of java
	...
	/**
	 * Return the current running environment (operating system name and architecture and java version).
	 * @return
	 */
	...
	/**
	 * Constructs a path name from its arguments and test if it represents an absolute path name
	 * in the operating system. If not, set it into the current working directory.
	 * 
