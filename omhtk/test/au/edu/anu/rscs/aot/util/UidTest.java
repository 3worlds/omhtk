...
class UidTest {
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#Uid()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#Uid(byte[], long, short)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#Uid(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#setMacAddress(int, int, int, int, int, int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#getMacAddress()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#getMacAddressAsLong()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#getTimeStamp()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#getCount()}.
	 */
	@Test
	void testGetCount() {
		long time = new DateTime().getTime(); 
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#toString()}.
	 */
	@Test
	void testToString() {
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#fileName(java.lang.String)}.
	 */
	@Test
	void testFileName() {
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#file(java.lang.String)}.
	 */
	@Test
	void testFile() {
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#toShortString()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#toHexString()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#equals(java.lang.Object)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#nullUid()}.
	 */
	@Test
	void testNullUid() {
		uid1 = Uid.nullUid();
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#isNull()}.
	 */
	@Test
	void testIsNull() {
	...
	/**
	 * Test method for {@link au.edu.anu.rscs.aot.util.Uid#compareTo(au.edu.anu.rscs.aot.util.Uid)}.
	 */
	@Test
	void testCompareTo() {
